...
class BB(mb.Compound):
    def __init__(self,r0BB=None,r0BBHB=None):
...
class BB_pvpy(BB):
    def __init__(self):
        super(BB_pvpy,self).__init__(r0BB=r0BB_pvpy,r0BBHB=r0BBHB_pvpy)
...
class BB_pvph(BB):
    def __init__(self):
        super(BB_pvph,self).__init__(r0BB=r0BB_pvph,r0BBHB=r0BBHB_pvph)
        for par in self.particles():
            par.name = '_BB_pvph'
...
class HB_pvpy(HB):
    def __init__(self):
        super(HB_pvpy,self).__init__(r0BBHB=r0BBHB_pvpy)
        for par in self.particles():
            par.name = '_HB_pvpy'
...
class HB_pvph(HB):
    def __init__(self):
        super(HB_pvph,self).__init__(r0BBHB=r0BBHB_pvph)
        for par in self.particles():
            par.name = '_HB_pvph'
